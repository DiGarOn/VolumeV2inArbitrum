...
describe("Hard", function() {
    ...
    before(async () => {
        ...
        noNameToken = await NNT.connect(owner).deploy("0x095454F216EC9485da86D49aDffAcFD0Fa3e5BE5", "0x095454F216EC9485da86D49aDffAcFD0Fa3e5BE5", "0x095454F216EC9485da86D49aDffAcFD0Fa3e5BE5");
        // console.log(await noNameToken.balanceOf(owner));

        MAIN = await hre.ethers.getContractFactory("main");
        // console.log("2");
        main = await MAIN.deploy(await noNameToken.target);
        ...
        await noNameToken.connect(owner).approve(await main.uniswapV2Router(), 1000000000000000000000000000000000n);
